    ...
    <div className="w-full flex flex-col justify-between h-full">
      <div className="w-full">
        <div
          ...
          className="w-full mt-12 bg-lightGray hover:bg-lightGrayHover p-3 rounded-lg cursor-pointer transition-colors duration-200 flex items-center gap-4"
        >
          <svg
        ...
        <div className="w-full mt-2 bg-lightGray hover:bg-lightGrayHover p-3 rounded-lg cursor-pointer transition-colors duration-200 flex items-center gap-4">
          ...
          <p className="text-customWhite">Create a Review</p>
        </div>
      ...
      <div className="w-full">
        ...
        <div className="w-full mt-2 p-3 rounded-lg cursor-not-allowed transition-colors duration-200 flex gap-4 items-center">
          <svg
            className="w-4 fill-greyText"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512"
          >
          ...
          <p className="text-greyText">Settings</p>
        </div>
      </div>
    </div>
  );
